...
class StockEntry(models.Model):
    ...
    purchase_price = models.DecimalField(max_digits=12, decimal_places=2, verbose_name='Purchase Price Per Unit')
...
class StockTransfer(models.Model):
    ...
    purchase_price = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, verbose_name='Purchase Price Per Unit')
